...
export function mergeSchoolWithExtras(school) {
  ...
  return {
    ...
    // Billing extras are authoritative after Paystack/wallet payment (unlock + revenue).
    plan_status:
      extras.plan_status != null && extras.plan_status !== ''
        ? extras.plan_status
        : school.plan_status || (paymentPlan ? 'pending' : null),
