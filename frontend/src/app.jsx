      ...
      <Router>
        <Routes>
          ...
          <Route path="/wallet" element={
            <SchoolAdminRoute><WalletPage /></SchoolAdminRoute>
          } />
          <Route path="/super-admin" element={
            <SuperAdminRoute><SuperAdmin /></SuperAdminRoute>
          } />
          <Route path="/super-admin/pending" element={
            <SuperAdminRoute><SuperAdmin /></SuperAdminRoute>
          } />
          <Route path="/super-admin/approved" element={
            <SuperAdminRoute><SuperAdmin /></SuperAdminRoute>
          } />
          <Route path="/super-admin/revenue" element={
            <SuperAdminRoute><PlatformRevenue /></SuperAdminRoute>
          } />
