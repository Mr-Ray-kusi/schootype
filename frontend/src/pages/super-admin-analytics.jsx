  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <section className="overflow-hidden rounded-xl border border-slate-600 bg-slate-800">
          <div className="border-b border-slate-600 p-5">
            ...
            <p className="text-xs text-slate-400">Headteachers and staff currently using the system</p>
          </div>
        ...
        <section className="overflow-hidden rounded-xl border border-slate-600 bg-slate-800">
          <div className="border-b border-slate-600 p-5">
            <h2 className="text-lg font-semibold text-white">Daily / weekly logins</h2>
            <p className="text-xs text-slate-400">Adoption per school</p>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <section className="overflow-hidden rounded-xl border border-slate-600 bg-slate-800">
          <div className="border-b border-slate-600 p-5">
            <h2 className="text-lg font-semibold text-white">Pages most visited</h2>
            <p className="text-xs text-slate-400">Are schools using Attendance and Fees, or only Reports?</p>
          </div>
          {topPages.length === 0 ? (
        ...
        <section className="overflow-hidden rounded-xl border border-slate-600 bg-slate-800">
          <div className="border-b border-slate-600 p-5">
            ...
            <p className="text-xs text-slate-400">Loads slower than {data?.slowPageMs || 3000} ms</p>
          </div>
          {slowPages.length === 0 ? (
              ...
              {slowPages.map((row) => (
                <li key={row.page} className="flex items-center justify-between gap-3 px-5 py-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-400">{row.count} slow load{row.count === 1 ? '' : 's'}</p>
                  </div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <section className="overflow-hidden rounded-xl border border-slate-600 bg-slate-800">
          <div className="border-b border-slate-600 p-5">
            <h2 className="text-lg font-semibold text-white">Key events</h2>
            <p className="text-xs text-slate-400">Logins, signups, payments, and slow pages</p>
          </div>
          {keyEvents.length === 0 ? (
        ...
        <section className="overflow-hidden rounded-xl border border-slate-600 bg-slate-800">
          <div className="border-b border-slate-600 p-5">
            ...
            <p className="text-xs text-slate-400">Schools that joined this week</p>
          </div>
          {newUsers.length === 0 ? (
