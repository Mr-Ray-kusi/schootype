  ...
  const schoolNavSections = [
...

    {
      ...
      items: [
        ...
        { name: 'Wallet', href: '/wallet', icon: Wallet, alwaysShow: true },
    ...
    ? [

        {
          ...
          items: [
            ...
            { name: 'Pending Registers', href: '/super-admin/pending', icon: Clock },

            { name: 'Approved Registers', href: '/super-admin/approved', icon: CheckCircle2 },

            { name: 'Platform Revenue', href: '/super-admin/revenue', icon: Wallet },
