/**
 * Frontend plan catalog (keep prices in sync with backend/plans.js PLAN_PRICES).
 * Display currency for Ghana Paystack merchants: GHS.
 * Backend charges using PAYSTACK_CURRENCY from .env (source of truth).
 */
...
const prices = PLAN_PRICES[PLAN_CURRENCY] || PLAN_PRICES.GHS;
